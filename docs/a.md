...
XML is a way of storing data, the XML file itself does not do anything and you cannot run it like a programme. If you are using XML, you need a programme to generate the XML file and a programme to consume its content.
